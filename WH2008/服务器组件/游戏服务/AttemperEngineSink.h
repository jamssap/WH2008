...
private:
	...
	//银行结果
	bool OnDBBankResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
...
private:
	...
	//发送结果
	void SendBankResult(IServerUserItem *pIServerUserItem, LONG lResultType, LONG lErrorCode, LPCTSTR pszDescribe, BYTE cbGameAction=0);
