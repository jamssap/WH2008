...
void CDlgCustomFace::OnPaint()
{
	...
	//COLORREF Color = /*RGB(0,51,102)*/RGB(49,99,140);
	dc.FillSolidRect(nXExcursion,nYExcursion,rcRect.Width()-2*nXExcursion,4,Color);
	dc.FillSolidRect(nXExcursion,rcRect.Height()-8,rcRect.Width()-2*nXExcursion,7,Color);
	dc.FillSolidRect(nXExcursion,nYExcursion+4,12,rcRect.Height()-nYExcursion-9,Color);
	dc.FillSolidRect(rcRect.Width()-nXExcursion-12,nYExcursion+4,12,rcRect.Height()-nYExcursion-9,Color);
