...
public:
	...
	//棋谱视图
	VOID SetManualView(bool bManualView)
	{
		m_bManualView = bManualView;
	}
	//等待规则
	VOID SetWaitGameRule(bool bWaitGameRule)
	{
		m_bWaitGameRule = bWaitGameRule;
	}
...
public:
	...
	{
		ControlSize = m_SizeBorad;
	}
	//获取位置
	VOID GetBenchmarkPos(CPoint & BenchmarkPos)
	{
		BenchmarkPos = m_BenchmarkPos;
	}
	//基准位置
