...
#define DBR_GR_BANK_TRANSFER            15                              //转出金币
...
protected:
	...
	//提取存储过程
	LONG SPBankDrawoutGold(DWORD dwUserID, LONGLONG lSwapScore, LONGLONG lCurrentScore, LONGLONG lCurrentBankScore, DWORD dwClientIP);
	//提取存储过程
	LONG SPBankStorageGold(DWORD dwUserID, LONGLONG lSwapScore, LONGLONG lCurrentScore, LONGLONG lCurrentBankScore, DWORD dwClientIP);
	//转帐存储过程
