...
public:
	...
	//显示银行
	virtual bool __cdecl ShowBankDialog(UINT nSelPage,DWORD dwOption);
...
private:
	...
	//银行消息
	bool OnIPCBank(const IPC_Head * pHead, const void * pIPCBuffer, WORD wDataSize, HWND hWndSend);
