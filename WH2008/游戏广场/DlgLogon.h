...
#define REG_USER_INFO			TEXT("Software\\VIPGame\\GamePlaza\\UserInfo")
#define REG_LOGON_SERVER		TEXT("Software\\VIPGame\\GamePlaza\\LogonServer")
...
protected:
	...
	//GDI变量
protected:
	CBrush								m_brControlBackground;			//控件背景	
