...
public:
	...
	//锁住银行
	virtual void __cdecl LockUserBank() { m_bLockBank=true; }
	//解锁银行
	virtual void __cdecl UnlockUserBank() { m_bLockBank=false; }
	//加锁状态
	virtual bool __cdecl IsLockedUserBank() { return m_bLockBank; }
