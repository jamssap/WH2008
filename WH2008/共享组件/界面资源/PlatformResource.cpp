...
bool __cdecl CPlatformResource::GetServerViewImage(tagServerViewImage * ServerViewImage)
{
	...
	ServerViewImage->uBtClearScore=DEF_IDB_BT_CLEAR_SCORE;
...
bool __cdecl CPlatformResource::GetPlatformFrameImage(tagPlatformFrameImage * PlatformFrameImage)
{
	...
	//框架按钮
	//PlatformFrameImage->uBtFrameHelp=DEF_IDB_FRAME_BT_HELP;
	...
	PlatformFrameImage->uBtPlazaNormal=DEF_IDB_BT_PLAZA_NORMAL;
	PlatformFrameImage->uBtPlazaActive=DEF_IDB_BT_PLAZA_AVTIVE;
	PlatformFrameImage->uBtRoomNormal=DEF_IDB_BT_ROOM_NORMAL;
	PlatformFrameImage->uBtRoomActive=DEF_IDB_BT_ROOM_AVTIVE;
...
bool __cdecl CPlatformResource::GetControlViewImage(tagControlViewImage * ControlViewImage)
{
	...
	ControlViewImage->uExchangeLoveliness=DEF_IDB_BT_EXCHANGE_LOVELINESS;
