...
VOID CGameClientView::RectifyGameView(INT nWidth, INT nHeight)
{
	...
	//棋盘位置
	INT nXChessBorad = m_EncircleInfoViewBack.nLBorder + 25;//zhangchen
...
//	m_rcChessManual.right = nWidth - nWidth / 2 + m_nFrameWidth / 2 + m_nManualWidth / 2 - m_EncircleInfoViewBack.nRBorder + 35;
	m_rcChessManual.left = nXChessBorad + m_SizeChessBorad.cx + 45;
	m_rcChessManual.right = nXChessBorad + m_SizeChessBorad.cx + 45 + 230;
...
//	INT nXManualPos = m_rcChessManual.left + m_rcChessManual.Width() / 2 - rcManualOpen.Width() / 2 - rcManualControl.Width() * 2;zhangchen
	INT nXManualPos = nXChessBorad + m_SizeChessBorad.cx + 45 + 35;
