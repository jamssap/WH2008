...
BOOL CGameFrameControl::OnInitDialog()
{
	...
	m_BrowerAD.Navigate(TEXT("http://www.123.com/AD/GameFrameAD.asp"),NULL,NULL,NULL,NULL);
...
{
	TCHAR szRuleUrl[128];
	_snprintf(szRuleUrl,sizeof(szRuleUrl),TEXT("http://www.123.com/GameRule.asp?KindID=%ld"),m_UserListView.m_wKindID);
