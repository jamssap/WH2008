...
public:
	...
	CSkinButton						m_btClearScore;						//负分清零
...
protected:
	...
	CSkinImage						m_ImageNoteL;						//通告资源
	CSkinImage						m_ImageNoteM;						//通告资源
	CSkinImage						m_ImageNoteR;						//通告资源
...
protected:
	...
	//银行消息
	bool OnSocketMainBank(CMD_Command Command, void * pBuffer, WORD wDataSize);
...
protected:
	...
	//负分清零
	afx_msg void OnBnClickedClearScore();
