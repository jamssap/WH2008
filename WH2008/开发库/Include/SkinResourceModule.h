...
struct tagPlatformFrameImage
{
	...
	UINT							uBtPlazaNormal;						//资源标识
	UINT							uBtPlazaActive;						//资源标识
	UINT							uBtRoomNormal;						//资源标识
	UINT							uBtRoomActive;						//资源标识
