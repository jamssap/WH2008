...
//主框架类
class CGameFrame : public CWnd, public ISplitterSink, public ITreeCtrlSink
{
	//状态变量
public:
...
protected:
	...
	//关闭房间
	LRESULT OnDblclkServerItem(WPARAM wParam, LPARAM lParam);
	//初始按钮
	LRESULT OnSetupInit(WPARAM wParam, LPARAM lParam);
	//程序更新
