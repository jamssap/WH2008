...
BOOL CRoomViewItem::OnInitDialog()
{
	...
	//m_BrowerAD.Navigate(TEXT("http://www.123.com/AD/GameRoomAD.asp"),NULL,NULL,NULL,NULL);
	m_BrowerAD.Navigate(TEXT("http://localhost:8023/AD/Default/GameAD.htm"),NULL,NULL,NULL,NULL);
