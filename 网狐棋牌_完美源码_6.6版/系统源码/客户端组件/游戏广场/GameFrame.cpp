	...
	case ItemGenre_Inside:
		{
			...
			WebBrowse(TEXT("http://www.123.com"),false);
	...
	case ItemGenre_Kind:		//游戏类型
		{
			...
			_snprintf(szRuleUrl,sizeof(szRuleUrl),TEXT("http://www.123.com/GameRule.asp?KindID=%ld"),pGameKind->wKindID);
...
BOOL CGameFrame::OnCommand(WPARAM wParam, LPARAM lParam)
{
	...
	case IDC_BT_BUTTON_5:				//功能按钮
		{
			if(IDC_BT_BUTTON_1==nCommandID)WebBrowse(TEXT("http://www.123.com/index.asp"),true);
			if(IDC_BT_BUTTON_2==nCommandID)WebBrowse(TEXT("http://www.123.com/PayBuy.asp"),true);
			if(IDC_BT_BUTTON_4==nCommandID)WebBrowse(TEXT("http://www.123.com/user/ExChange.asp"),true);
			if(IDC_BT_BUTTON_5==nCommandID)WebBrowse(TEXT("http://www.123.com/bbs/index.asp?action=frameon"),true);
...
int CGameFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//m_BrowerAD.Navigate(TEXT("http://www.123.com/AD/GamePlazaAD.asp"),NULL,NULL,NULL,NULL);
	m_BrowerAD.Navigate(TEXT("http://localhost:8023/AD/newlgn.htm"),NULL,NULL,NULL,NULL);
