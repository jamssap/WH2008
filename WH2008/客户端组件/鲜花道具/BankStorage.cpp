	...
	
{
	...
	//分配内存
	m_pPageDlg[0]=new CPageDlg(IDD_PAGE_DIALOG1,TEXT("存入金币"),TEXT("确认存入"));
	m_pPageDlg[1]=new CPageDlg(IDD_PAGE_DIALOG2,TEXT("取出金币"),TEXT("确认取出"));
	m_pPageDlg[2]=new CPageDlg(IDD_PAGE_DIALOG3,TEXT("金币转帐"),TEXT("确认转出"));
