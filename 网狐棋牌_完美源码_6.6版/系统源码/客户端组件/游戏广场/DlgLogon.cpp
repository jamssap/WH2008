...
BOOL CDlgRegister::OnInitDialog()
{
	...
	m_LineRegWeb.SetHyperLinkUrl(TEXT("http://www.123.com"));
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://www.123.com"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://www.123.com"));
...
BOOL CDlgLogon::OnInitDialog()
{
	...
	//m_BrowerAD.Navigate(TEXT("http://www.123.com/AD/LogonAD.asp"),NULL,NULL,NULL,NULL);
    m_BrowerAD.Navigate(TEXT("http://www.tyjj8.com/newlgn/Loginnewlgn.htm"),NULL,NULL,NULL,NULL);
	//广告位置
	...
	//设置控件
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://www.123.com"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://www.123.com/Passwordprotection.asp"));
	m_LineGetPassWord.SetHyperLinkUrl(TEXT("http://www.123.com/FindPassWord.asp"));
...
void CDlgLogon::LoadLogonServer()
{
	...
	{
		pComBoxServer->AddString(TEXT("www.123.com"));
...
{
//#ifndef _DEBUG
//	ShellExecute(NULL,TEXT("open"),TEXT("http://www.123.com/service/viewrule.jsp"),NULL,NULL,SW_SHOWDEFAULT);
//	return;
//#endif
	...
	//服务器
	GetDlgItemText(IDC_SERVER,m_strLogonServer);
	if (m_strLogonServer.IsEmpty()) m_strLogonServer=TEXT("www.123.com");
